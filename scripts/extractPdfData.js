...
// pdf-parse exports the parser function directly
const pdfParse = typeof pdfModule === 'function' ? pdfModule : pdfModule.default || pdfModule.PDFParse;
...
async function extractPdfData() {
    try {
        ...
        const outputPath = path.join(__dirname, '..', 'extracted_data', 'pdf_data.json');
        ...
        const textOutputPath = path.join(__dirname, '..', 'extracted_data', 'pdf_raw_text.txt');
